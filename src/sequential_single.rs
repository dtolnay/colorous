...
pub const GREENS: SequentialSingle = SequentialSingle {
...
pub const GREYS: SequentialSingle = SequentialSingle {
...
pub const ORANGES: SequentialSingle = SequentialSingle {
...
pub const PURPLES: SequentialSingle = SequentialSingle {
...
pub const REDS: SequentialSingle = SequentialSingle {
